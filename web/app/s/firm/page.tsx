...
import { NFooter, NHeader, PageHero, SectionMark, useLang } from "../../n/chrome";
import { EASE, GOLD, GOLD_DEEP, GOLD_SOFT, HAIR, INK_MUTED, NAVY, EXTRA } from "../../n/copy";
...
export default function SFirmPage() {
