...
import { NHeader, PageHero, SectionMark, useLang } from "../../n/chrome";
import { CONTACT, DIRECTORY, EXTRA, GOLD, GOLD_DEEP, GOLD_SOFT, HAIR, INK_MUTED, NAVY, OFFICE } from "../../n/copy";
...
export default function SContactPage() {
      ...
      <section className={styles.callBand}>
        ...
        <div className={styles.wrap} style={{ position: "relative", zIndex: 2 }}>
          <div className={styles.callGrid}>
            ...
            <DeviceCall palette={DEVICE} number={OFFICE.phone} href={OFFICE.phoneHref} callLabel={c.callLabel} serif="var(--font-bodoni), serif" mono="var(--font-plex-mono), monospace" className={styles.callCanvas} />
          </div>
        </div>
      </section>
        ...
        <div className={styles.wrap} style={{ position: "relative", zIndex: 2 }}>
          <div className={styles.contactFootRow}>
            ...
            <div className={styles.contactFootActions}>
              ...
              <Link href="/s" className={styles.backLink}>← {x.back}</Link>
            </div>
          </div>
